...
namespace GLPL {
        ...
        GLenum mode) : ISingleLine2D(std::move(parentDimensions)) 
    {
        ...
        std::cout << internalData[0] << std::endl;
        std::cout << internalData[1] << std::endl;
        ...
        createAndSetupBuffers(vertDataSizeBytes, indicesDataSizeBytes, &internalData[0], &internalIndices[0], 2 * sizeof(internalData[0]));
